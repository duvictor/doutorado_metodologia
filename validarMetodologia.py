...
def executar_metodologia(use_cuda, model, label_colours, args, key, folder_dcm, window_center, window_width):
    try:
        ...
        # nifti_file = r"/exame/CQ500CT195.nii.gz"
        # nifti_file = r"/exame/{}.nii.gz".format(key)
        nifti_file = r"E:\PycharmProjects\pythonProject\build\{}_janelado.nii.gz".format(key)
